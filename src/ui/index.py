...
class Ui_index(object):
    def setupUi(self, index):
        ...
        self.edit_keyword.setGeometry(QtCore.QRect(130, 40, 421, 35))
        self.edit_keyword.setObjectName("edit_keyword")
        self.btn_search = QtWidgets.QPushButton(self.tab_search)
        self.btn_search.setGeometry(QtCore.QRect(589, 40, 80, 35))
        self.btn_search.setObjectName("btn_search")
        self.search_result = QtWidgets.QGroupBox(self.tab_search)
        self.search_result.setGeometry(QtCore.QRect(20, 100, 761, 401))
        ...
        self.verticalGroupBox = QtWidgets.QGroupBox(self.search_result)
        self.verticalGroupBox.setObjectName("verticalGroupBox")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalGroupBox)
        self.verticalLayout.setObjectName("verticalLayout")
        self.label_image = QtWidgets.QLabel(self.verticalGroupBox)
        self.label_image.setText("")
        self.label_image.setObjectName("label_image")
        self.verticalLayout.addWidget(self.label_image)
        self.btn_download = QtWidgets.QPushButton(self.verticalGroupBox)
        self.btn_download.setObjectName("btn_download")
        self.verticalLayout.addWidget(self.btn_download)
        self.search_result_layout.addWidget(self.verticalGroupBox)
    ...
    def retranslateUi(self, index):
        ...
        index.setWindowTitle(_translate("index", "Kraken"))
        ...
        self.btn_download.setText(_translate("index", "下载"))
